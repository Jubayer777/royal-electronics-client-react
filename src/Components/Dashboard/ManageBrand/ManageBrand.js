                                ...
                                <tbody>
                                        {
                                            currentItems.map(bd=>
                                                <tr key={bd.id}>
                                                    <td data-label="Brand Name">{bd.brand_name}</td>
                                                    <td data-label="No Of Products Available" >{bd.product.length}</td>
                                                    <td data-label="Action"><p ><span style={{ cursor: 'pointer' }} onClick={() => handleDeleteBrand( bd.id)}><FontAwesomeIcon icon={faTrashAlt} /></span>   <span style={{ cursor: 'pointer' }} onClick={() => handleEditBrand( bd.id)}><FontAwesomeIcon icon={faEdit} /></span></p></td>
                                                </tr>
                                            )
                                        }
                                </tbody>
