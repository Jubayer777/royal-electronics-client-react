                        ...
                        <tbody>
                            {
                             currentItems.map(od =>
                              ...
                              <tr key={od.id}>
                                ...
                                <td data-label="Customer Name">{od.user.name}</td>
                                ...
                                <td data-label="Status">
                                    <select className='order-status' name="status" onChange={(e)=>handleStatus(od,e)}  defaultValue={od.status}>
                                                <option value="Pending">Pending</option>
                                                <option value="On going">On Going</option>
                                                <option value="Delivered">Delivered</option>
                                            </select>
                                    </td>
                                <td data-label="Action"><span style={{ cursor: 'pointer' }} onClick={() => handleDeleteOrder(od.id)}><FontAwesomeIcon icon={faTrashAlt} /></span></td>
                             </tr>
                            )
                            }
                        </tbody>
