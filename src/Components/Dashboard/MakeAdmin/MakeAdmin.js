        ...
        <div>
            ...
            <div className='add_container'>        
                <form onSubmit={handleUpload}>
                            ...
                            <br />
                            <input className="input_field double_field" onBlur={handleBlur} placeholder='example@gmail.com' name="email" type="email" required />
                            <br/>
                            <button type="submit" className="submit-btn">Submit</button>
                </form> 
                    {
                        errorsData.email && errorsData.email.map(e=><p className='error-txt'>{e}</p>)
                    }
                    {
